...
_images=np.load("./data/20251112_redsylinder1/test/right_imgs.npy")
#_images=np.load("./data/20250710/test/right_imgs.npy")
_joints=np.load("./data/20251112_redsylinder1/test/right_arm_states.npy")
#_joints=np.load("./data/20250710/test/right_arm_states.npy")
_images_tactile=np.load("./data/20251112_redsylinder1/test/right_digit_imgs.npy")
...
joint_bounds_raw = np.load("./data/20251112_redsylinder1/test/teleop_right_arm_states.npy")
...
# Inference
img_size = 64
image_list, joint_list, image_tactile_list = [], [], []
...
for loop_ct in range(nloop):
    ...
    # predict rnn
    y_image, y_joint, enc_pts, dec_pts, state, y_image_tactile, enc_tactile_pts, dec_tactile_pts = model(img_t, joint_t, img_tactile_t, state)# すべて0,1正規化されて出力
    # denormalization

...
_images=np.load("./data/20251216_redrectangular/test/right_imgs.npy")
#_images=np.load("./data/20250710/test/right_imgs.npy")
_joints=np.load("./data/20251216_redrectangular/test/right_arm_states.npy")
#_joints=np.load("./data/20250710/test/right_arm_states.npy")
# _images_tactile=np.load("./data/20251216_redrectangular/test/right_digit_imgs.npy")
...
joint_bounds_raw = np.load("./data/20251216_redrectangular/test/teleop_right_arm_states.npy")
